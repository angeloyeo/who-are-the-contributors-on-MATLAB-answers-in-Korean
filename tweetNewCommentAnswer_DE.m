...
try
    xDoc = xmlread('https://de.mathworks.com/matlabcentral/answers/questions?format=atom&status=answered&language=de');
    % まず各投稿は <entry></entry>
...
for ii=1:height(newitem_list)
    ...
    if thisAuthor == "MathWorks Support Team"
        ...
        % 投稿文
        status = "Neuer Kommentar oder Antwort für " + newline + "「" + newitem_list.titles(ii) + "」 -> ";
